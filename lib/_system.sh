...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código SAC Integrado...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema SAC Integrado...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar o SAC Integrado...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos bloquear o SAC Integrado...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o SAC Integrado...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos Alterar os Dominios do SAC Integrado...${GRAY_LIGHT}"
  printf "\n\n"
...
system_node_install() {
  print_banner
  printf "${WHITE} 💻 Instalando Node.js e dependências para o SAC Integrado...${GRAY_LIGHT}"
  printf "\n\n"
